...
import com.exz.antcargo.activity.adapter.PopGoodsAdapter;
...
public class PopGoods extends BasePopupWindow {
    ...
    public PopGoods(Activity context, final List<NewestGoodsBean> list) {
        super(context);
    ...
    public PopGoods(Activity context, int w, int h) {
        super(context, w, h);
    }
