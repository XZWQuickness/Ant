...
public class OriginAdapter<T> extends BaseAdapter {
    private List<T> objects = new ArrayList<T>();
    private Activity context;
    private String phoneNum = "";

    public OriginAdapter(Activity context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final List<LogisticsDetailebean.OriginListEntity> list = (List<LogisticsDetailebean.OriginListEntity>) objects;
        ...
        try {
            ...
            viewHodler.tv_photo_null.setText(URLDecoder.decode(list.get(position).getAddress(), "utf-8"));
