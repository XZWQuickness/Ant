...
public class TextAdapterGu extends ArrayAdapter<String> {
	...
	public TextAdapterGu(Context context, List<String> listData, int sId, int nId) {
	...
	public TextAdapterGu(Context context, String[] arrayData, int sId, int nId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (selectedText != null && selectedText.equals(mString)) {
			...
			view.setBackgroundDrawable(mContext.getResources().getDrawable(normalDrawbleId));// 璁剧疆鏈�涓姸鎬佽儗鏅浘鐗�
		}
