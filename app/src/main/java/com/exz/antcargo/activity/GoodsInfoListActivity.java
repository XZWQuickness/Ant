 ...
 * 货源信息
 */
@ContentView(R.layout.activity_goods_info_list)
public class GoodsInfoListActivity extends BaseActivity implements View.OnClickListener, XListView.IXListViewListener {
    ...
    private Context c = GoodsInfoListActivity.this;
    ...
    public void initView() {
        ...
        adapter = new GoodsInfoAdapter<>(GoodsInfoListActivity.this);
        ...
        popuWindowAdater = new PoppuWindowMoreAdapter<PopuWindowCheXingBean>(GoodsInfoListActivity.this);
        ...
        zaichongAdapter = new ZaiChongAdapter<PopuWindowCheXingBean>(GoodsInfoListActivity.this);
        ...
        carLenthAdapter = new CarLenthAdapter<PopuWindowCheXingBean>(GoodsInfoListActivity.this);
    ...
    public void initData() {
        ...
        xUtilsApi.sendUrl(GoodsInfoListActivity.this, "post", p, false, new XUtilsApi.URLSuccessListenter() {
            ...
            public void OnSuccess(NewEntity content, JSONObject result) {
                if (content.getResult().equals(ConstantValue.RESULT)) {
                    ...
                    Intent intent = new Intent(GoodsInfoListActivity.this, DiaLogActivity.class)
    ...
    private void initPicker() {
        ...
        if (!TextUtils.isEmpty(SPutils.getString(c, "city"))) {
            ...
            data.add(province_);
            for (AddressPicker.Province p : JSON.parseArray(SPutils.getString(GoodsInfoListActivity.this, "city"), AddressPicker.Province.class)) {
    ...
    private void infoList() {
        ...
        XUtilsApi xUtilsApi = new XUtilsApi();
        RequestParams params = new RequestParams(Constant.GOODS_LIST);
        ...
        if (!TextUtils.isEmpty(placeOfReceipt)) {
            ...
            params.addBodyParameter("origin", placeOfReceipt);//  收货地
        }
        if (!TextUtils.isEmpty(destinationAreaId)) {

            params.addBodyParameter("destination", destinationAreaId);//目的地 区域编号
        }
        ...
        if (!TextUtils.isEmpty(useCarType)) {
            params.addBodyParameter("useCarTypeId", useCarType);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_placeOfReceipt:
                if (Utils.isNetworkConnected(GoodsInfoListActivity.this)) {
                    refsh = true;
                    Intent intent = new Intent(GoodsInfoListActivity.this, ChoiceLocationActivity.class);
            ...
            case R.id.tv_mudidi://目的地
                refsh = true;
                AddressPicker pickerMudidi = new AddressPicker(GoodsInfoListActivity.this, data);
                ...
                pickerMudidi.setOnAddressPickListener(new AddressPicker.OnAddressPickListener() {
                    ...
                    public void onAddressPicked(AddressPicker.Province province, AddressPicker.City city, AddressPicker.County county) {
                        ...
                        destinationAreaId = (TextUtils.isEmpty(province.getAreaName()) ? "" :
                                TextUtils.isEmpty(city.getAreaName()) ? province.getAreaName() :
                                        TextUtils.isEmpty(county.getAreaName()) ? city.getAreaName() : county.getAreaName());
            ...
            case R.id.tv_chafa_time://出发时间
                ...
                DatePicker picker = new DatePicker(GoodsInfoListActivity.this);
            ...
            case R.id.tv_gongduo://更多
                ...
                refsh = true;
                View menuView4 = LayoutInflater.from(GoodsInfoListActivity.this).inflate(R.layout.pop_gongduo, null);
                ...
                final RadioButton rb_03 = (RadioButton) menuView4.findViewById(R.id.rb_03);
                ...
                popupWindow.showAsDropDown(GoodsInfoListActivity.this.findViewById(R.id.rl_lin), 0, 0);
