...
public class MiddleFilterRightView extends LinearLayout implements ViewBaseAction{
	...
	public MiddleFilterRightView(Context context, String[] provice, String[][] city) {
		super(context);
	...
	public MiddleFilterRightView(Context context) {
		super(context);
		init(context);
	}
