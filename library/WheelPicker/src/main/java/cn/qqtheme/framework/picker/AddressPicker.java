...
public class AddressPicker extends LinkagePicker {
    ...
    public static class City extends Area {
        public City(ArrayList<County> counties) {
    ...
    private DatePicker.OnCancelListener onCancelListener;
    public interface OnCancelListener{
        void cancel();
    }

    public DatePicker.OnCancelListener getOnCancelListener() {
        return onCancelListener;
    }

    public void setOnCancelListener(DatePicker.OnCancelListener onCancelListener) {
